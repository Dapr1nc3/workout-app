...
$("#monday . description")
   .val(localStorage.getItem("monday"));

$("#tuesday . description")
   .val(localStorage.getItem("tuesday"));

$("#wednesday . description")
   .val(localStorage.getItem("wednesday"));

$("#thursday . description")
   .val(localStorage.getItem("thursday"));

$("#friday . description")
   .val(localStorage.getItem("friday"));

$("#saturday . description")
   .val(localStorage.getItem("saturday"));

$("#sunday . description")
   .val(localStorage.getItem("sunday"));

$("#height . description")
   .val(localStorage.getItem("height"));

$("#weight . description")
   .val(localStorage.getItem("weight"));

$("#fat . description")
   .val(localStorage.getItem("fat"));

$("#bmass . description")
   .val(localStorage.getItem("bmass"));

$("#goal-week . description")
   .val(localStorage.getItem("goal-week"));

$("#prev-goal . description")
   .val(localStorage.getItem("prev-goal"));

$("#chall-goal . description")
   .val(localStorage.getItem("chall-goal"));
